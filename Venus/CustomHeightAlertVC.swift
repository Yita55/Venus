...
class CustomHeightAlertVC : UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        titleLabel.text = PropertyUtils.readLocalizedProperty("Setting Height")
    ...
    @IBAction func donePressAction(_ sender: UIButton) {
        ...
        let index = heightPicker.selectedRow(inComponent: 0)
        selectItem = heightArray[index]
        
        print(selectItem)
        
        settingDelegate?.updateSettingTableView(height: selectItem)
