...
public class CellContent{
    ...
    // Content add accessoryCell
    private var addAccessory:Bool = false
    ...
    public init(title: String, detail: String, addTrigger:Bool = true, addAccessory:Bool = false){
        self.title = title
        self.detail = detail
    ...
    public func getContentAccessory() -> Bool{
        return addAccessory
    }
